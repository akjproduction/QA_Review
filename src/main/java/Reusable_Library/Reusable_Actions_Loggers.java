...
public class Reusable_Actions_Loggers {
    ...
    public static void mouseHover(WebDriver driver, String xpath, ExtentTest logger, String elementName){
        ...
        try {
            ...
            logger.log(LogStatus.INFO,"Unable to hover on " + elementName + " Error:" + e);
    ...
    public static void checkTitle(WebDriver driver, String webAddress, ExtentTest logger,String expectedTitle) {
        ...
        if (actualTitle.contains(expectedTitle)) {
            ...
            logger.log(LogStatus.INFO, "Title Contains " + expectedTitle);
        } else {
            System.out.println("Page title doesn't contain " + expectedTitle);
            logger.log(LogStatus.FAIL, "Page title doesn't contain " + expectedTitle);
            getScreenShot(driver,expectedTitle,logger);
        }
    }//end of check title
